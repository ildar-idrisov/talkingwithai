...
RUN python3 -m pip install --default-timeout=1000 --no-cache-dir setuptools
RUN python3 -m pip install --default-timeout=1000 --upgrade pip
...
RUN python3 -m pip install --default-timeout=1000 -r requirements.txt
